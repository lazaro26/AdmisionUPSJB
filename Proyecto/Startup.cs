...
using Serilog;
using static Proyecto.Constantes;
...
namespace Proyecto
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IDPostulante), typeof(DPostulante));
            services.AddScoped(typeof(IDSedes), typeof(DSedes));
            services.AddScoped(typeof(IDEspecialidad), typeof(DEspecialidad));
